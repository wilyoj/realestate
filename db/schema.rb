...
ActiveRecord::Schema.define(version: 2022_05_24_142752) do

  create_table "estates", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
  ...
  add_foreign_key "estates", "locations"
end
